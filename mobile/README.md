...
Долгий вход на сайт: после логина приложение получает mobile-токен (`api/mobile_session.php`, до 180 дней) и при каждом PIN/биометрии обновляет PHP-сессию — повторный логин/пароль не нужен.

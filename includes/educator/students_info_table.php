...
$studentInfoColumns = [
    ...
    ['key' => 'mother_name', 'label' => student_parent_field_label('mother', 'name')],
    ['key' => 'mother_phone', 'label' => student_parent_field_label('mother', 'phone')],
    ['key' => 'mother_workplace', 'label' => student_parent_field_label('mother', 'workplace')],
    ['key' => 'mother_education', 'label' => student_parent_field_label('mother', 'education')],
    ['key' => 'father_name', 'label' => student_parent_field_label('father', 'name')],
    ['key' => 'father_phone', 'label' => student_parent_field_label('father', 'phone')],
    ['key' => 'father_workplace', 'label' => student_parent_field_label('father', 'workplace')],
    ['key' => 'father_education', 'label' => student_parent_field_label('father', 'education')],
